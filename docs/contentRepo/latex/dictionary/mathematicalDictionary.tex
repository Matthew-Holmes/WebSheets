...
%
% WORDS THE SERVER ADDS
%
% When a worksheet's vocabulary key uses a word this file does not define, the
% server adds it at the end, under a heading saying nobody has checked it yet.
% Those entries are the ones most worth reading: they were written for one
% sheet and have not been agreed by anybody. Reword one and it changes
% everywhere; move it up into the topic it belongs to whenever you like.
% =====================================================================
